...
export function assertNotStrictEquals(actual, expected, msg) {
    ...
    throw new AssertionError(msg !== null && msg !== void 0 ? msg : `Expected "actual" to be strictly unequal to: ${format(actual)}\n`);
}
/**
...
export function assertRejects(fn, errorClassOrCallback, msgIncludesOrMsg, msg) {
